...
autoload run-help
```
Требуется сделать небольшое примечание касательно цветов для ls: мой <code>~/.dir_colors</code> вы можете получить <a href="http://dumpz.org/14522/">здесь</a>, почитать о том, что же сподвигло меня менять умолчальные настройки — <a href="http://debiania.blogspot.com/2009/05/ls_10.html">тут</a>.
