...
Если хочется ещё и иконку внизу страницы — это тоже несложно:<ol><li>Открываем Панель инструментов Blogger;</li><li>переходим в «Макет»;</li><li>сменяем вкладку на «Изменить HTML»;</li><li>в самый конец кода, перед &lt;/body&gt; ставим такой код:
```
